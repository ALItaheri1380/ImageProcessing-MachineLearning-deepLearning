...
img1 = My_Imresize_Euclidean_Distance(Test_2, Resizing_Factor_1);
figure;
imshow(img1,[]);
title('Test 1 Resized by 0.435 using Euclidean Distance');

img2 = My_Imresize_Euclidean_Distance(Test_2, Resizing_Factor_2);
figure;
imshow(img2,[]);
title('Test 1 Resized by 1.503 using Euclidean Distance');
